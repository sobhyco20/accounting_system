...
urlpatterns = [
    ...
    path("purchases/", views.purchases_entry, name="purchases_entry"),
    path("api/purchases/grid/", api.api_purchases_grid_get, name="api_purchases_grid_get"),
    path("api/purchases/grid/save/", api.api_purchases_grid_save, name="api_purchases_grid_save"),
    path("api/purchases/export-xlsx/", api.api_purchases_export_xlsx, name="api_purchases_export_xlsx"),
    path("api/purchases/import-xlsx/", api.api_purchases_import_xlsx, name="api_purchases_import_xlsx"),

    path("api/sales/export-xlsx/", api.api_sales_export_xlsx, name="api_sales_export_xlsx"),
    path("api/sales/import-xlsx/", api.api_sales_import_xlsx, name="api_sales_import_xlsx"),
]
